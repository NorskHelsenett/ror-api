...
func Create(ctx context.Context, projectInput *apicontracts.ProjectModel) (*apicontracts.Project, error) {
	...
	_, err = auditlog.Create(ctx, "Project created", models.AuditCategoryProject, models.AuditActionCreate, models.ActorFromIdentity(identity), createdProject, nil)
	if err != nil {
...
func Update(ctx context.Context, projectId string, input *apicontracts.ProjectModel) (*apicontracts.Project, *apicontracts.Project, error) {
	...
	_, err = auditlog.Create(ctx, "Project updated", models.AuditCategoryProject, models.AuditActionUpdate, models.ActorFromIdentity(identity), newObject, oldObject)
	if err != nil {
...
func Delete(ctx context.Context, projectId string) (bool, *apicontracts.Project, error) {
	...
	_, err = auditlog.Create(ctx, "Project deleted", models.AuditCategoryProject, models.AuditActionDelete, models.ActorFromIdentity(identity), deleted, nil)
	if err != nil {
