...
func Create(ctx context.Context, input *apicontracts.OperatorConfig) (*apicontracts.OperatorConfig, error) {
	...
	_, err = auditlog.Create(ctx, "New operator config created", models.AuditCategoryConfiguration, models.AuditActionCreate, models.ActorFromIdentity(identity), created, nil)
	if err != nil {
...
func Update(ctx context.Context, id string, input *apicontracts.OperatorConfig) (*apicontracts.OperatorConfig, *apicontracts.OperatorConfig, error) {
	...
	_, err = auditlog.Create(ctx, "New operator config updated", models.AuditCategoryConfiguration, models.AuditActionUpdate, models.ActorFromIdentity(identity), newObject, oldObject)
	if err != nil {
		rlog.Error("failed to create auditlog", err)
	}
...
func Delete(ctx context.Context, id string) (bool, error) {
	...
	_, err = auditlog.Create(ctx, "New operator config updated", models.AuditCategoryConfiguration, models.AuditActionUpdate, models.ActorFromIdentity(identity), nil, deleted)
	if err != nil {
		rlog.Error("failed to create auditlog", err)
	}
