...
func Create(ctx context.Context, desiredversion apicontracts.DesiredVersion) (*apicontracts.DesiredVersion, error) {
	...
	_, err = auditlog.Create(ctx, "New desired version created", models.AuditCategoryConfiguration, models.AuditActionCreate, models.ActorFromIdentity(identity), creationresult, nil)
	if err != nil {
...
func UpdateByKey(ctx context.Context, key string, desiredversion apicontracts.DesiredVersion) (*apicontracts.DesiredVersion, error) {
	...
	_, err = auditlog.Create(ctx, "Desired version updated", models.AuditCategoryConfiguration, models.AuditActionUpdate, models.ActorFromIdentity(identity), updateResult, nil)
	if err != nil {
		rlog.Errorc(ctx, "failed to create auditlog", err)
		return nil, err
	}
...
func DeleteByKey(ctx context.Context, key string) (int64, error) {
	...
	_, err = auditlog.Create(ctx, "Desired version deleted", models.AuditCategoryConfiguration, models.AuditActionDelete, models.ActorFromIdentity(identity), key, nil)
	if err != nil {
		rlog.Errorc(ctx, "failed to create auditlog", err)
		return 0, err
	}
