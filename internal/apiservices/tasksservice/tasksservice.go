...
func Create(ctx context.Context, taskInput *apicontracts.Task) (*apicontracts.Task, error) {
	...
	_, err = auditlog.Create(ctx, "New task created", models.AuditCategoryConfiguration, models.AuditActionCreate, models.ActorFromIdentity(identity), createdTask, nil)
	if err != nil {
...
func Update(ctx context.Context, taskId string, taskInput *apicontracts.Task) (*apicontracts.Task, *apicontracts.Task, error) {
	...
	_, err = auditlog.Create(ctx, "Task updated", models.AuditCategoryConfiguration, models.AuditActionUpdate, models.ActorFromIdentity(identity), newObject, oldObject)
	if err != nil {
...
func Delete(ctx context.Context, taskId string) (bool, *apicontracts.Task, error) {
	...
	_, err = auditlog.Create(ctx, "Task deleted", models.AuditCategoryConfiguration, models.AuditActionDelete, models.ActorFromIdentity(identity), nil, deleted)
	if err != nil {
