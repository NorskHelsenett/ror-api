...
require (
	github.com/NorskHelsenett/ror v1.21.8
...
require (
	...
	gitlab.com/biffen/saute v0.0.5 // indirect
	...
	go.opentelemetry.io/contrib/instrumentation/go.mongodb.org/mongo-driver/v2/mongo/otelmongo v0.0.0-20260316083141-e92a00df8617 // indirect
